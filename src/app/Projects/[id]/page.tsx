...
function Page({ params }: { params: { id: string } }) {
  ...
  const onLightBox = () => {setOpenLB(true)};
          ...
          {arr.map((item, key) => (
            ...
            >
              <Image
                ...
                height="170"
                alt=""
                src="https://plus.unsplash.com/premium_photo-1752954678452-2b4946f15ae5?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              />
            </div>
          ))}
        </div>
